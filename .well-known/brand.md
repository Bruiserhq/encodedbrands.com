...
BCP is read in three places, and we design for all three:

- **Inside the brand.** The brand's own marketing agents — copy, creative, media, compliance — consume BCP to preserve senior-strategist judgment at machine scale.
- **Across the vendor stack.** Their agents read BCP to make better decisions on the brand's behalf. BCP is the brand-specific calibration layer that currently reaches those systems through imperfect, high-latency channels — interviews, account-rep notes, reconstructed intent.
- **Beyond the brand.** Consumer-facing agents — ChatGPT, Claude, Perplexity, Gemini, agentic storefronts — read BCP to describe the brand as the brand wants to be described.

## Who we're for

Three audiences: brand leaders building marketing in the age of the agent (CMOs, heads of brand, founders of brand-serious companies), platform partners whose agents make decisions on brands' behalf (vendor platforms, DSPs, creative-gen tools), and developers and protocol designers who will decide whether this standard is serious.

## What we're not

Not a closed SaaS. Not an AI-powered marketing platform. Not an agency. Not a brand-management dashboard. We maintain an open protocol, run a consulting practice, and operate a monitoring product. Three things. Each one clearly scoped.
...
- 2026-04-18 — v0.1.0 initial publication.
