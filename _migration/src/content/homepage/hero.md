---
meta_left: Encoded · A brand consultancy & protocol company
meta_right:
  - text: Est. 2026
  - text: Remote-first
  - text: BCP v0.1 (draft)
eyebrow: Now encoding founding brands · BCP v0.1
headline_lines:
  - text: Express
    style: normal
    break_after: false
...
ctas:
  ...
  - label: Or copy the free prompt
    href: '#copy-prompt'
    ghost: true
quote: The brand deck rotting on a shared drive is the antagonist of this decade. Your agents can't read it. So you customers can't feel it.
ticker:
  - text: Open spec · CC BY 4.0
  - text: Reference code · MIT
  - text: Same convention as AGENTS.md
prompt_card_label: Your first brand.md, today.
